...
- **生图贴纸 / Generated stickers:** `assets/stickers/art/` 中 12 款图像由本技能项目以原创文字提示经 Nexora 生成，未使用第三方图片参考。目录记录各文件来源与校验值。公开再分发这些图像前需单独核对所用服务条款；上述 MIT 声明不自动覆盖生图资产。 / Twelve images were generated from original text prompts without third-party image references. Verify service terms before public redistribution; the MIT statement above does not automatically cover generated art.
