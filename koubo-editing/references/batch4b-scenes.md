...
|---|---|---|---|
|tpl-neon-green 荧光绿 / `tpl-neon-green`|白色斜方括号标题，荧光宋体副标题与下划线；轻白正文与粗荧光重点|最多三句独立时钟错位留屏；可选圆窗需构图理由|非逐字插入曲线；不能仅为装饰/规避隐私裁掉人物手势|
|tpl-ultra-purple Ultra·紫 / `tpl-ultra-purple`|紫粗斜标题、白小副题；轻正文/粗重点反差|normal横排、bilingual独立英文、vertical直立逐字竖列；紫色侧标|几何倾斜为替代字形；未做人物身份竖牌|
|tpl-warm-orange 暖系橙黄 / `tpl-warm-orange`|站酷快乐圆趣标题、橙/奶油/深红边；白正文黄重点|最多三句，各有紧贴橙底与错位位置、整块pop入场|未做原点赞/定位贴纸、黑幕揭示、发光尾标；参考640×852适配3:4/9:16|
|tpl-black-white 基础黑白 / `tpl-black-white`|白斜标题配逐行黑底，白厚边正文加橙重点|单句稳态、独立橙色直立竖词标|跟随头部聚光及双镜头模糊转场未做；严禁用圆窗伪装聚光|
