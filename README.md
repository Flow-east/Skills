...
| `koubo-editing` | [v0.4.0](https://github.com/Flow-east/Skills/blob/koubo-editing-v0.4.0/koubo-editing/README.md) | Reviews Chinese speech, plans semantic cuts and visual/audio treatment, and renders a video with audio. | Chinese talking-head video editing with reusable styles. | [English guide](koubo-editing/README.md) · [中文说明](koubo-editing/README.zh-CN.md) |
